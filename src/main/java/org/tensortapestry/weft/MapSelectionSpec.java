...
public class MapSelectionSpec {
    ...
    public static class MapSelectionSpecBuilder {
        ...
        public MapSelectionSpecBuilder nonEmptyList(String name) {
            return item(Item.builder().name(name).nonEmptyList().build());
        }

        public MapSelectionSpecBuilder emptyList(String name) {
            return item(Item.builder().name(name).emptyList().build());
        }
    ...
    public static class Item {
        ...
        public static class ItemBuilder {
            ...
            public Item.ItemBuilder nonEmptyList() {
                return shape(Item.NONEMPTY_LIST);
            }

            public Item.ItemBuilder emptyList() {
