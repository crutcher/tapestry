...
public interface HasNamedPermute<T extends HasNamedPermute<T>> extends HasPermute<T> {
   ...
   * @throws IndexOutOfBoundsException if the given dimension name is not in this
   *         dimension map.
   */
   ...
   * @throws IndexOutOfBoundsException if the given names are not a permutation of this
   *         dimension.
   */
  @Nonnull
   ...
   *
   * <p>A permutation is an ordered list of distinct names, each of which is in the set of
   * dimension
