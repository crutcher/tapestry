...
public class ZRangeTest implements ZSpaceTestAssertions {
    ...
    public void test_byCoords() {
        ...
        // Empty ranges.
        assertThat(ZRange.newFromShape(0, 0).byCoords(BufferOwnership.CLONED).stream().toList()).isEmpty();

        // Scalar ranges.
        assertThat(new ZRange(new ZPoint(), new ZPoint()).byCoords(BufferOwnership.CLONED).stream().toList())
