...
public class ZRangeTest implements ZSpaceTestAssertions {
    ...
    public void test_byCoords() {
        ...
        assertThat(range.byCoords(BufferOwnership.CLONED).stream().toList())
                .containsExactly(
                        new int[]{2, 3},
                        new int[]{2, 4},
                        new int[]{3, 3},
        ...
        assertThat(range.byCoords(BufferOwnership.REUSED).stream().toList())
                .containsExactly(
                        new int[]{3, 4},
                        new int[]{3, 4},
                        new int[]{3, 4},
        ...
        assertThat(range.byCoords(BufferOwnership.REUSED).stream().map(int[]::clone).toList())
                .containsExactly(
                        new int[]{2, 3},
                        new int[]{2, 4},
                        new int[]{3, 3},
        ...
        // Empty ranges.
        assertThat(ZRange.newFromShape(0, 0).byCoords(BufferOwnership.CLONED).stream().toList())
                .isEmpty();

        // Scalar ranges.
        assertThat(
                new ZRange(new ZPoint(), new ZPoint()).byCoords(BufferOwnership.CLONED).stream().toList()
        )
    ...
    public void test_contains() {
        ...
        {
            // Empty Ranges
            var empty = ZRange.newFromShape(0, 0);
