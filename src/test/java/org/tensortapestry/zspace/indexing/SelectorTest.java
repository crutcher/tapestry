...
class SelectorTest implements WithAssertions {
    ...
    public void testParseSelectors() {
        assertThat(Selector.parseSelectors("1,2,3")).containsExactly(new Index(1), new Index(2), new Index(3));
        assertThat(Selector.parseSelectors("1,2:3")).containsExactly(new Index(1), new Slice(2, 3, null));
