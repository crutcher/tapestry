...
public class IndexingFnsTest implements ZSpaceTestAssertions {
  ...
  public void test_shapeToLFSStrides() {
    assertThat(IndexingFns.shapeToLfsStrides(new int[] { 2, 1, 3 }))
      .isEqualTo(new int[] { 3, 0, 1 });

    assertThatExceptionOfType(IllegalArgumentException.class)
      .isThrownBy(() -> IndexingFns.shapeToLfsStrides(new int[] { 2, 1, -1, 3 }));
  }
  ...
  public void test_commonBroadcastShape() {
    ...
    assertThat(IndexingFns.commonBroadcastShape(new int[] { 2, 10, 1 }, new int[] { 1, 3 }))
      .isEqualTo(new int[] { 2, 10, 3 });
  }
}
