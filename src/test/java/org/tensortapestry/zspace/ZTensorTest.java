...
public class ZTensorTest implements ZSpaceTestAssertions {
    ...
    public void test_select() {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> t.select(new Selector() {
                    @Override
    ...
    public void test_sliceDim() {
        ...
        {
            // FIXME - negative step slices are broken.


            var tensor = ZTensor.newZeros(3);
            ZTensor actual = tensor.sliceDim(0, -2, null, -1);
            System.out.println("shape: " + actual.shapeAsList());
            System.out.println("strides: " + Arrays.toString(actual.stride));
            System.out.println("offset: " + actual.data_offset);
