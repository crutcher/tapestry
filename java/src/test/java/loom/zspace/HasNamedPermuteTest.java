...
public class HasNamedPermuteTest extends BaseTestClass {
  ...
  public void test_assertNDim() {
    var example =
        Example.builder().shape(new int[] {1, 2, 3}).names(new String[] {"a", "b", "c"}).build();
  ...
  public void test_assertSameNDim() {
    var example1 =
        Example.builder().shape(new int[] {1, 2, 3}).names(new String[] {"a", "b", "c"}).build();
    var example2 =
        Example.builder().shape(new int[] {4, 5, 6}).names(new String[] {"x", "y", "z"}).build();
    var example3 =
        Example.builder()
