...
public final class ZTensor implements HasDimension, HasToJsonString, HasPermute, HasSize {
  ...
  @Nonnull private final ImmutableList<Integer> shapeList;
   ...
   */
  @Contract(pure = true)
  public static @Nonnull int[] defaultStridesForShape(@Nonnull int[] shape) {
  ...
  public ZTensor transpose() {
    return permute(Utility.aoti(ndim()));
  }
